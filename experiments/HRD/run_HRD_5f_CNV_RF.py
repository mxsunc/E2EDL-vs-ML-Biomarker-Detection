...
cptac_df = all_cancers_df_cptac.merge(scarhrd_df[['Patient ID', 'HRD_binary', 'HRD-sum', 'cohort']],
...
output_dir = "predictions_RF_CNV/"
os.makedirs(output_dir, exist_ok=True)
output_path = os.path.join(output_dir, "predictions_HRD_RF_CNV_all_folds.csv")
...
for cohort in predictions_df['cohort'].unique():
    ...
    cohort_path = os.path.join(output_dir, f"predictions_HRD_RF_CNV_{cohort}.csv")
...
print(f"  --output-dir evaluation_results_RF_CNV/")
