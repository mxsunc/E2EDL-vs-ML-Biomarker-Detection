...
output_dir = "predictions_RF_mutCNV/"
os.makedirs(output_dir, exist_ok=True)
output_path = os.path.join(output_dir, "predictions_HRD_RF_mutCNV_all_folds.csv")
...
for cohort in predictions_df['cohort'].unique():
    ...
    cohort_path = os.path.join(output_dir, f"predictions_HRD_RF_mutCNV_{cohort}.csv")
...
print(f"  --output-dir evaluation_results_RF_mutCNV/")
