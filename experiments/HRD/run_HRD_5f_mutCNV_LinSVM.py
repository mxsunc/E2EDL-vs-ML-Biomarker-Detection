...
for j in range(5):
    ...
    base_svm = LinearSVC(C=1.0, class_weight="balanced", random_state=42, max_iter=5000)
...
output_dir = "predictions_LinSVM_mutCNV/"
os.makedirs(output_dir, exist_ok=True)
output_path = os.path.join(output_dir, "predictions_HRD_LinSVM_mutCNV_all_folds.csv")
...
for cohort in predictions_df['cohort'].unique():
    ...
    cohort_path = os.path.join(output_dir, f"predictions_HRD_LinSVM_mutCNV_{cohort}.csv")
...
print(f"  --output-dir evaluation_results_LinSVM_mutCNV/")
