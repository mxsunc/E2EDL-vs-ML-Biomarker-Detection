#%%
"""HRD Multimodal DL - SNV+CNV late fusion (cross-attention). 5-fold CV."""
...
all_predictions = []
model_name = 'DL_HRD_SNVCNV_crossatt_gistic'
...
for j in range(5):
    ...
    # Late fusion via bidirectional cross-attention
...
output_dir = "predictions_DL_SNVCNV_crossatt_gistic/"
os.makedirs(output_dir, exist_ok=True)
output_path = os.path.join(output_dir, "predictions_HRD_SNVCNV_crossatt_gistic_all_folds.csv")
...
for cohort in predictions_df['cohort'].unique():
    ...
    cohort_path = os.path.join(output_dir, f"predictions_HRD_SNVCNV_crossatt_gistic_{cohort}.csv")
...
print(f"  --output-dir evaluation_results_DL_SNVCNV_crossatt_gistic/")
