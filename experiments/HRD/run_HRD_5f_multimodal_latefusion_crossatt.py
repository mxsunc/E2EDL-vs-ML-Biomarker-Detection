...
callbacks = [tf.keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=0.002, patience=5, mode='min', restore_best_weights=True,start_from_epoch = 1)]
...
for j in range(5):
    ...
    with open(".../HRDwithlungucec_mil_encoder_weights_fold"+str(j+1)+".pkl", "rb") as f:
