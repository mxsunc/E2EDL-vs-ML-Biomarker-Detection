...
output_path = os.path.join(output_dir, "predictions_HRD_RF_mut_all_folds.csv")
...
for cohort in predictions_df['cohort'].unique():
    ...
    cohort_path = os.path.join(output_dir, f"predictions_HRD_RF_mut_{cohort}.csv")
